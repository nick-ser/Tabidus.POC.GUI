...
namespace Tabidus.POC.GUI.UserControls.Label
{
    ...
    /// </summary>
    public partial class OSCriteriaElement : UserControl
    {
        public OSCriteriaElement()
        {
            InitializeComponent();
            Model = new OSCriteriaViewModel(this);
        }

        public OSCriteriaElement(bool isVisibleAddBtn) : this()
        {
            Model = new OSCriteriaViewModel(this, isVisibleAddBtn);
        }

        public OSCriteriaViewModel Model
        {
            get { return DataContext as OSCriteriaViewModel; }
        ...
        private void BtnSub_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (parent != null && parent.Children.Count > 1)
            {
                ...
                var el = parent.Children[parent.Children.Count - 1] as OSCriteriaElement;
                if (el != null)
                {
                    var evm = el.Model;
                ...
                var elfirst = parent.Children[0] as OSCriteriaElement;
                if (elfirst != null)
                {
        ...
        private void BtnAdd_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (labelElem != null)
            {
                ...
                var isChecked = labelElem.Model.ChbOsChecked;
                var fieldName = CommonConstants.EndpointOperatingSystem;
        ...
        private void Addbackgrount_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (parent != null)
            {
                ...
                var el = new OSCriteriaElement(true);
        ...
        private void CbOsOpes_DropDownClosed(object sender, System.EventArgs e)
        {
            PageNavigatorHelper.GetMainContentViewModel<LabelViewModel>().OnSaveLabel(null);
        }

        private string currentText = "";
        private void TxtOsCriteria_LostFocus(object sender, RoutedEventArgs e)
        {
            //if (currentText != TxtOsCriteria.Text)
            //{
            //    PageNavigatorHelper.GetMainContentViewModel<LabelViewModel>().OnSaveLabel(null);
            //    currentText = TxtOsCriteria.Text;
            //}

        }

        private void CbOsCriteria_DropDownClosed(object sender, System.EventArgs e)
        {
            PageNavigatorHelper.GetMainContentViewModel<LabelViewModel>().OnSaveLabel(null);
        }
    }
